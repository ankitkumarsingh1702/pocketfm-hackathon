...
from mood_config import (
    DESTINATION_TARGETS, SHELF_COPY, rank_destinations, slider_deltas_to_axis_deltas,
)
from rerank import HeuristicReranker, RerankedItem
from retrieval import Retriever, ScoringWeights
from schemas import Destination, MoodAxes, MoodQuery, ResultCard, Shelf
...
class MoodSearchEngine:
    ...
    def build_shelf(
        ...
        judged: Sequence[RerankedItem] = self.reranker.rerank(query, destination, candidates)
    ...
    def search(self, query: MoodQuery, profile=None) -> list[Shelf]:
        ...
        if profile is not None:
            from persona import AffinityScorer
