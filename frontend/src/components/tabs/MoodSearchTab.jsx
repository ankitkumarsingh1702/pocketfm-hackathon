...
function SearchBox({ initial, onSearch, loading }) {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ display: "flex", gap: 10, flexWrap: "wrap", maxWidth: 620 }}
      >
        <input
          id="mood-query"
          value={text}
      ...
      >
        No genres and no browse grid — describe the feeling, in English or
        Hinglish.
      </p>
    </form>
  );
...
export default function MoodSearchTab() {
  ...
  if (mode === "safety") {
    return (
      ...
      >
        <MoodSafety
          message={data.safety_message}
          resources={data.support_resources}
        />
        <div>
  ...
  return (
    ...
    >
      ...
      <SearchBox
        initial={mood.lastText}
        onSearch={mood.search}
      ...
      {mode === "shelves" && (
        <>
          ...
          >
            ...
            >
              That feeling reads three ways, so here are all three. Your pick is
              the answer — nothing was guessed.
            </p>
