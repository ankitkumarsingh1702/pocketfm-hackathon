/**
 * The studio's single icon family: 24-grid stroke icons drawn inline so they
 * inherit `currentColor` and need no asset requests. Decorative by default —
 * pair every icon with a visible or screen-reader label at the call site.
 */
