 ...
 * DB for the Plot Hole demo; these are clean, self-contained scripts a presenter
 ...
 *
 * Each story is a full, multi-scene episode (scenes split on `---`, matching
 * SCENE_DELIMITER) rich in named characters, places, clues, and concrete facts,
 * so the canon extraction, plot-hole traversal, and cliffhanger search all have
 * real material to work with. The final scene of each is a deliberately soft
 * ending — good raw material for the Cliffhanger Optimizer to lift.
 */

/** @typedef {{id:string,title:string,genre:string,blurb:string,episode:string,text:string}} LibraryStory */
...
export const STORY_LIBRARY = [
  {
    ...
    blurb: 'A night-shift telephone operator keeps getting calls from a number that was disconnected years ago.',
    episode: 'Episode 1',
    text: `Scene 1: Ira Sohal takes the 11 p.m. shift at the Deonar telephone exchange, alone with two hundred sleeping switchboards. Her supervisor, Mr. Wagle, warns her never to answer line 9 — it was cut off in 2011.
---
...
Scene 8: That night line 9 rings early, at 1:12. The child says, "You came. Now they can stop counting." Then, for the first time, she asks Ira a question: "Didi — do you remember me?" Ira's hand freezes on the switchboard.`,
  },
  {
    ...
    genre: 'Romance Drama',
    blurb: 'Two strangers keep swapping notebooks on the same Mumbai local — until one of them stops showing up.',
    episode: 'Episode 1',
    text: `Scene 1: Every 8:47 Churchgate fast, Aarav Menon writes in a green notebook and "forgets" it on seat 3. Every evening it comes back with a stranger's reply in the margins, signed only "M."
---
...
Scene 8: On that morning Aarav stands on platform 3 with the green notebook and two tickets to nowhere in particular. The 8:47 pulls in. The doors open. He waits to see who steps off.`,
  },
  {
    ...
    blurb: 'A retired inspector is pulled back for one case: a locked-room death in a building he already investigated thirty years ago.',
    episode: 'Episode 1',
    text: `Scene 1: Inspector Farhan Qureshi, three months into retirement, is called to Sea Breeze Mansion, Colaba. Antique dealer Vikram Rao is dead in his study — door bolted from inside, key still in the lock.
---
...
Scene 8: Farhan calls it in. As backup climbs the stairs, the vacant flat's door clicks shut from the inside, and the wall clock in Rao's study, untouched, quietly begins to tick again.`,
  },
  {
    ...
    blurb: 'The blind queen\'s handmaiden weaves a tapestry that keeps predicting the war — until her thread runs out.',
    episode: 'Episode 1',
    text: `Scene 1: In the palace of Hastinapur, the handmaiden Suvarna weaves for the blind queen Gandhari. Her loom is said to be a gift from a wandering rishi: whatever it weaves at dawn comes true by dusk.
---
...
Scene 8: At dawn, Suvarna threads her loom with a single strand of her own white hair to complete the hundredth figure. Before she can pass it through, a war conch sounds across the plain of Kurukshetra. Her hand hovers over the empty space.`,
  },
  {
    ...
    blurb: 'In 2071, citizens pay their taxes in memories. An auditor discovers her own childhood was collected years ago.',
    episode: 'Episode 1',
    text: `Scene 1: Bengaluru, 2071. The state no longer takes money — it takes memories, siphoned at the Revenue Spire and stored as light. Auditor Devika Rao is the best collector in Sector 12.
---
...
Scene 8: Devika holds the canister of her stolen childhood in one hand and her auditor's badge in the other. The vault alarm begins to rise. She has ninety seconds to decide which version of herself walks out.`,
  },
  {
    ...
    blurb: 'Six strangers board the last night bus through the hills. By the first stop, one of them is already dead.',
    episode: 'Episode 1',
    text: `Scene 1: The 9:40 night service from Kathgodam to Ranikhet leaves with six passengers and one driver as the first snow begins. The road ahead is a single lane cut into the mountain.
---
