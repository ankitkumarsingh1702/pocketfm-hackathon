/**
 * Hindi/Hinglish ready-made stories — used ONLY by the Cliffhanger Optimizer's
 * story picker (passed in via the `stories` prop). Every other lens keeps the
 * default English `STORY_LIBRARY`. Each is a single, rich 8-scene episode that
 * ends on an open beat — good raw material for the optimizer and the soft-girl
 * Hindi "hear the difference" narration.
 */
...
export const HINDI_STORY_LIBRARY = [
  story(
    'aakhiri-ghanti',
    'आख़िरी घंटी',
    'सस्पेंस थ्रिलर',
